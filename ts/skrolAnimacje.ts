...
var controller;
var caloscTa = this;
var proporcja:number =1;
    var tablicaPoziomowStron:Array<any>;
...
przewinNaStrone(num:number){
   ...
   // controller.scrollTo("#strona" + num);
    ...
    scrollTo : {
        y : tablicaPoziomowStron[num], // scroll position of the target along y axis
...
//proporcja = 1;
    ...
    zmianaProporcji(daneprop:Array<any>)
    {
        proporcja = daneprop[1];
    }
...
window.poz2S = sortedX;
   ...
   function znowumachnij(obiekt,obiekt2,rot:number,kie)
    {
  ...
  function ruchloga(logo,rzadL:Number)
    {
...
var kolLoga:Number =(caloscTa["rzad" + rzadL])[numerWrzedzie];
  ...
  //  console.log("kolLoga:" + kolLoga);
    ...
    {
         var kontent6:string = $(".tekst6").html();
...
function dodajLitery(wyraz:string,klasadod:string):string
    {
        var nowazawartoscA = "";
    ...
    tablicaPoziomowStron.push(1080/proporcja + poczekaj);
        ...
        var liczbaWy = (1080)/proporcja + 2000 + (1080 - wysokosc / skala) + poczekaj;
            ...
            if(proporcja>1)
            {
                ...
                var nowaWysokosc:number = wysokosc / skala;
